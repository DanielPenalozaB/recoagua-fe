...
import { GuideFilterDto, GuideStatus } from '@/types/guide'
          ...
          filters={[
            {
              ...
              title: 'Estado',
              options: [
                { label: statusTypeTranslation.get(GuideStatus.PUBLISHED)!, value: GuideStatus.PUBLISHED },
                { label: statusTypeTranslation.get(GuideStatus.ARCHIVED)!, value: GuideStatus.ARCHIVED },
                { label: statusTypeTranslation.get(GuideStatus.DRAFT)!, value: GuideStatus.DRAFT },
              ],
            },
          ]}
        />
