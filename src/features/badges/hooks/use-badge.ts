...
import { BadgeFilterDto, CreateBadgeDto, UpdateBadgeDto } from '@/types/badge';
...
const useCreateBadge = () => {
  ...
  return useMutation({
    mutationFn: (badgeData: CreateBadgeDto) => badgeService.createBadge(badgeData),
    onSuccess: () => {
...
export {
  useCreateBadge, useDeleteBadge, useUpdateBadge, useBadge, useBadges
};
