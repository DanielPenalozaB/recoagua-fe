...
export default function SetPasswordPage({ params }: { params: Promise<{ password_token: string }> }) {
    ...
    if (isLoading) {
      return (
        <div className="loading-section text-center">
          <p className="text-xl font-bold mb-2 text-neutral-800">Validando token...</p>
    ...
    if (!isValidToken && errorMessage) {
      return (
        <div className="error-section text-center">
          <h2 className="text-xl font-bold mb-2 text-neutral-800">Token Inválido</h2>
        ...
        <div className="password-setup-section">
          ...
          <Form {...form}>
            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
              ...
              >
                {form.formState.isSubmitting ? 'Estableciendo...' : 'Establecer Contraseña'}
              </Button>
            </form>
          </Form>
        </div>
