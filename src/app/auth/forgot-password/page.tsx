  ...
  const forgotPassword = async (email: string ) => {
    ...
    try {
      ...
      if (!response.ok) {
        ...
        throw new Error('Ocurrió un error al generar el enlace de restablecimiento. Por favor, intenta nuevamente.');
      }

      setIsLoading(false);
      toast.success('Petición de restablecimiento de contraseña enviada con éxito. Por favor, revisa tu bandeja de entrada o spam.');
      setShowMessage(true);
      ...
      setIsLoading(false);
      const message = err.message || 'Ocurrió un error al generar el enlace de restablecimiento. Por favor, intenta nuevamente.';
    ...
    if (isLoading) {
      return (
        <div className="loading-section text-center">
          <p className="text-xl font-bold mb-2 text-neutral-800">Enviando petición de restablecimiento de contraseña...</p>
      ...
      return (
        <div className="flex items-center flex-col gap-4">
          ...
          <p className="text-sm text-neutral-600 text-center">
            A tu email se le ha enviado un enlace para establecer tu contraseña. Por favor, revisa tu bandeja de entrada o spam.
          </p>
        </div>
      );
    }
    ...
    if (errorMessage) {
      return (
        <div className="error-section text-center">
          <h2 className="text-xl font-bold mb-2 text-neutral-800">Falló la petición</h2>
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Input placeholder='Ingresa tu email' type='email' autoComplete='email' {...field} />
                  </FormControl>
                  <FormMessage />
                </FormItem>
              )}
