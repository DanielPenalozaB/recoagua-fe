		...
		<>
				...
				<div className="flex items-center gap-2 px-4">
					...
					<Breadcrumb>
						<BreadcrumbList>
							...
							<BreadcrumbSeparator />
							<BreadcrumbItem>
								<BreadcrumbPage>Crear reto</BreadcrumbPage>
							</BreadcrumbItem>
						</BreadcrumbList>
					</Breadcrumb>
				</div>
			...
			<Main className="flex flex-col gap-6 mx-auto p-4 max-w-2xl">
				<div className="flex flex-wrap justify-between items-center space-y-2 mb-2">
					<div>
						<h2 className="font-bold text-2xl tracking-tight">Crear reto</h2>
						<p className="text-muted-foreground">
							Crea un nuevo reto en la plataforma
						</p>
					</div>
				</div>
				<ChallengesCreateEditForm />
			</Main>
		</>
	);
}
