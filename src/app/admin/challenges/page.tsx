...
import { ChallengesPrimaryButtons, ChallengesProvider, ChallengesTable } from '@/features/challenges'
    ...
    <ChallengesProvider>
      ...
      <Main>
        <div className='flex flex-wrap justify-between items-center space-y-2 mb-2'>
          <div>
            <h2 className='font-bold text-2xl tracking-tight'>Retos</h2>
            <p className='text-muted-foreground'>
              Gestiona los retos de la plataforma
            </p>
          </div>
          <ChallengesPrimaryButtons />
        </div>
