...
import { GuidesPrimaryButtons, GuidesProvider, GuidesTable } from '@/features/guides'
    ...
    <GuidesProvider>
      ...
      <Main>
        <div className='flex flex-wrap justify-between items-center space-y-2 mb-2'>
          <div>
            <h2 className='font-bold text-2xl tracking-tight'>Guías</h2>
            <p className='text-muted-foreground'>
              Gestiona los guías de la plataforma
            </p>
          </div>
