    ...
    <>
      <header className="flex justify-between items-center gap-2 h-16 shrink-0">
        <div className="flex items-center gap-2 px-4">
          ...
          <Breadcrumb>
            <BreadcrumbList>
              <BreadcrumbItem>
                <BreadcrumbLink href="/admin/cities">Ciudades</BreadcrumbLink>
              </BreadcrumbItem>
              <BreadcrumbSeparator />
              <BreadcrumbItem>
                <BreadcrumbPage>Editar ciudad</BreadcrumbPage>
              </BreadcrumbItem>
            </BreadcrumbList>
          </Breadcrumb>
        </div>
      ...
      <Main className="flex flex-col gap-6 mx-auto p-4 max-w-2xl">
        <div className='flex flex-wrap justify-between items-center space-y-2 mb-2'>
          <div>
            <h2 className='font-bold text-2xl tracking-tight'>Editar ciudad</h2>
            <p className='text-muted-foreground'>
              Edita los detalles de la ciudad
            </p>
          </div>
        </div>
        <CitiesCreateEditForm cityId={Number(city_id)} />
      </Main>
    </>
  )
}
