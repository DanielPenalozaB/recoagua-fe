...
import { HelpCircle, MapPin, Home, Droplets } from 'lucide-react';
...
export default function CalculatorPage() {
  ...
  const calculateResults = () => {
    const selectedMethod = COLLECTION_METHODS.find(m => m.id === method) || COLLECTION_METHODS[0];
    ...
    <div className="h-full flex flex-col items-center">
      <div className="card-header p-6 border-b w-full">
        ...
        <p className="card-description text-sm text-gray-500">
          Ajusta los parámetros para calcular tu potencial de recolección de agua
        </p>
      </div>
      ...
      <div className="card p-6 space-y-6 max-w-md w-full">
              ...
              <TooltipProvider>
                <Tooltip>
                  ...
                  <TooltipContent className="max-w-xs rounded-lg text-sm">
                    <p>La ubicación determina la cantidad de lluvia disponible para recolectar durante el año, siendo el factor principal que influye en el potencial hídrico de tu sistema.</p>
                  </TooltipContent>
                </Tooltip>
              </TooltipProvider>
            </Label>
          ...
          <Label htmlFor="method" className="text-sm font-medium flex items-center gap-2">
            ...
            <TooltipProvider>
              <Tooltip>
                ...
                <TooltipContent className="max-w-xs rounded-lg text-sm">
                  <p>Cada método tiene una eficiencia inherente basada en su capacidad para interceptar y canalizar el agua de lluvia sin pérdidas significativas.</p>
                </TooltipContent>
              </Tooltip>
            </TooltipProvider>
          </Label>
            ...
            <Label htmlFor="area" className="text-sm font-medium flex items-center gap-2">
              ...
              <TooltipProvider>
                <Tooltip>
                  ...
                  <TooltipContent className="max-w-xs rounded-lg text-sm">
                    <p>La superficie total expuesta a la lluvia que puede capturar agua. Es la proyección horizontal del área de captación, medida en metros cuadrados. A mayor área, mayor volumen de agua recolectable por cada milímetro de lluvia.</p>
                  </TooltipContent>
                </Tooltip>
              </TooltipProvider>
            </Label>
        ...
        {/* Efficiency Slider */}
        <div className="space-y-2">
          <Label htmlFor="efficiency" className="text-sm font-medium flex items-center gap-2">
            ...
            <TooltipProvider>
              <Tooltip>
                ...
                <TooltipContent className="max-w-xs rounded-lg text-sm">
                  <p>El porcentaje de agua de lluvia que efectivamente se logra capturar y almacenar. Considera las pérdidas por evaporación, derrames, filtración y la calidad del sistema de canalización y filtrado instalado.</p>
                </TooltipContent>
              </Tooltip>
            </TooltipProvider>
          </Label>
