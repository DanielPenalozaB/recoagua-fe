...
import { Challenge, ChallengeFilterDto, CreateChallengeDto, UpdateChallengeDto } from '@/types/challenge';

export class ChallengeService extends ApiService {
  async getChallenges(filters?: ChallengeFilterDto): Promise<PaginationResponse<Challenge>> {
  ...
  async updateChallenge(id: number, challengeData: UpdateChallengeDto): Promise<Challenge> {
